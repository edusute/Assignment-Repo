...
theme: default
paginate: true
header: 'AI Lesson 02a: Decision Trees - Visual Thinking'
footer: 'Medina County Career Center'
---

# Decision Trees - Visual Thinking

**Lesson 02a: Understanding Decision Logic**
...
While decision trees can be both human-developed/coded or artificial intelligence — there are decision trees that ARE considered supervised machine learning/AI (humans just provide the labels... correct inputs and outputs).

These supervised machine learning models are everywhere:
- Netflix recommendations
- Spam filters
- Fraud detection
- Medical diagnosis apps
- Self-driving car braking systems

---

## Why Decision Trees Matter

Decision trees are the **foundation of machine learning** because they're:
- Fast
- Transparent
- Actually work better than fancy neural networks for many real-world problems

**Once you understand how decision trees make decisions, you understand the core concept behind ALL AI.**

---

## Not AI Yet... But Soon!

Although this isn't "AI" yet, we will soon start the process of training AI using data in our upcoming lessons.

**This is just our first exploration into machine learning!**
...
## Building Your Own Decision Tree (cont.)
...
## When Are Decision Trees NOT Ideal?
...
## Complex Decision Tree Example (cont.)
...
**Two volunteers come up to the board!**

The class will help us build a tree that answers: 
...
**Next lesson:** We'll code these decision trees in Python!
